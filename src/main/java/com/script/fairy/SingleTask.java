...
public class SingleTask extends TaskContent {
    ...
    public void inOperation() throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            result = mFairy.findPic(143,632,450,718,"Dialogbox2.png" );//"Dialogbox.png"
                ...
                if (result.sim > 0.8f) {
                    ...
                    if (result.sim > 0.9f) {
                        if (str.equals("drfbjjc.png")) {
                            mFairy.onTap(0.8f, result, 250,647,258,655, "防bug点击", Sleep);
                        }
    ...
    public void achievement() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_2() throws Exception {
                ...
                result1 = mFairy.findPic(335, 139, 391, 650, "Leadachievement.png");
                mFairy.onTap(0.8f, result1, "有成就", Sleep);
